...
namespace Simpleprograms
{
    internal class TeachingStaff : StaffDetails
    {
        ...
        public TeachingStaff(string? collegename, string? collegeaddress, int eno, string? name, string? address, string? dept, double basic_salary, int da, int hra, int cca, int pf) :base(collegename,collegeaddress ,eno,name,address)
        {
            this.dept = dept;
